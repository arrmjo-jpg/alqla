...
final class ArticleCdnPurge
{
    public static function purge(
        ...
        rescue(static fn () => self::doPurge($article, $oldPath, $oldCategoryIds, $oldTags, $oldAuthorId));
    }
    ...
    private static function doPurge(
        ...
        FrontendRevalidate::tags(FrontendCacheTags::article($article, $oldCategoryIds, $oldTags, $oldAuthorId));
