...
final class MediaUsage
{
     ...
     * أغلفة تصنيفات/قوائم الفيديو، أغلفة البثّ وتصنيفاته، الأعداد ونُسخها، أغلفة
     * تصنيفات المحتوى، صور أعضاء الفريق، إبداعات الإعلانات (أُضيفت 2026-07-23 —
     * كانت الثلاثة الأخيرة غائبة فتُحذف/تُنظَّف أصولها اليتيمة رغم استخدامها فعلياً).
     *
     * @var list<string>
     */
