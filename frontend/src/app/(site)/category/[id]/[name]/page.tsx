        ...
        <main className="min-w-0 lg:col-span-8 space-y-8">
          {result.total === 0 ? (
            ...
            >
              ...
              <h2 className="font-heading text-xl font-bold text-fg">لا توجد مقالات في هذا القسم بعد</h2>
              <p className="max-w-md text-sm text-muted-foreground">ستظهر هنا مقالات «{category.name}» فور نشرها.</p>
            </div>
          ) : (
            <>
