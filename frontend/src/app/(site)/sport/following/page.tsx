  ...
  return (
    <div className="bg-surface-2">
      <Container className="py-6">
        ...
        {/* إعلان متعدّد — أعلى المحتوى. */}
        <AdZone zone="aalan_fy_alryada_mtadd" className="mb-6 flex justify-center" />
        ...
        {/* إعلان متعدّد — أسفل المحتوى. */}
        <AdZone zone="aalan_fy_alryada_mtadd" className="mt-6 flex justify-center" />
      </Container>
    </div>
  );
}
