      ...
      <Container className="py-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[340px_1fr]">
          ...
          <main className="flex min-w-0 flex-col gap-6">
            ...
            {/* إعلان متعدّد — فوق محتوى كل تاب (في كل التابات). */}
            ...
            {active === 'lineup' ? (
              ...
              <>
                {/* إعلان متعدّد مكثّف — بين كل كرت وآخر في تفاصيل المباراة (عبّة بكل مكان). */}
                {shotMap && (
                  <>
                    <MatchShotMap data={shotMap} />
                    <AdZone zone="aalan_fy_alryada_mtadd" className="flex justify-center" />
                  </>
                )}
                ...
                {d.topPerformers.length > 0 && (
                  <>
                    <MatchTopPerformers categories={d.topPerformers} />
                    <AdZone zone="aalan_fy_alryada_mtadd" className="flex justify-center" />
                  </>
                )}
                ...
                {h2h && h2h.forms.length > 0 && (
                  <>
                    <MatchRecentForm forms={h2h.forms} />
                    <AdZone zone="aalan_fy_alryada_mtadd" className="flex justify-center" />
                  </>
                )}
            ...
            {/* إعلان متعدّد — أسفل محتوى كل تاب. */}
            <AdZone zone="aalan_fy_alryada_mtadd" className="flex justify-center" />
          </main>
        </div>
      </Container>
