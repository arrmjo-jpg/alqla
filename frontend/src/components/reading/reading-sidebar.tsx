...
import { SidebarMarkets } from './sidebar-markets';
import { SidebarNewsWidget } from './sidebar-news-widget';
import { SidebarReels } from './sidebar-reels';
...
// الريلز + بورصة عمّان/الذهب (تحت تريندينغ مباشرةً، بنفس ترتيب الرئيسية) + مباريات اليوم + روابط
// متابعة السوشيل ميديا. كلّ قسم يُخفي نفسه بصمت لو بلا محتوى حقيقيّ (لا عنصر فارغ). مصدر واحد
// للجانب (DRY) بدل تكراره في كلّ صفحة.
