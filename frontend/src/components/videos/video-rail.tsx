...
function RailArrow({
  ...
  return (
    <button
      ...
      aria-label={label}
      tabIndex={-1}
      className={`absolute top-1/2 z-20 hidden size-10 -translate-y-1/2 items-center justify-center bg-surface text-fg shadow-lg ring-1 ring-border transition md:flex ${
