...
// مَن يجب أن يكون مسجّلاً (وإلا 401 ⇒ العميل يحوّل لـ/login). الحفظ والإعجاب كلاهما يتطلّبان
// دخولاً لكلّ الأنواع الثلاثة حاليّاً (بلا استثناء للمقال) — القراءة (الحالة) وحدها تبقى عامّة
// دائماً (انظر التعليق أعلاه)، لا الإعجاب.
